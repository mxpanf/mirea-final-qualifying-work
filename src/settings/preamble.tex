...
% Настройка нумерованных списков: замена скобки на точку
\renewcommand\labelenumi{\theenumi.}

\setlist[itemize]{left=1.25cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=0pt}
\setlist[enumerate]{left=1.25cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=0pt}
\setlist[enumerate,2]{left=1.25cm, topsep=0pt, partopsep=0pt, parsep=0pt, itemsep=0pt}
...
% Настройка отступа после подписи рисунка
\captionsetup[figure]{
    singlelinecheck=true,     % Проверка одиночной строки
    belowskip=-10pt,             % Убираем отступы ниже подписи
}

% Настройка подписей к таблицам
\captionsetup[table]{
    justification=raggedright, % Выравнивание по левому краю
    singlelinecheck=false,      % Проверка одиночной строки
    skip=0pt,
}
